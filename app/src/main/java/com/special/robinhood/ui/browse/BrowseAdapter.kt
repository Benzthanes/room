package com.special.robinhood.ui.browse
...
class BrowseAdapter @Inject constructor(): androidx.recyclerview.widget.RecyclerView.Adapter<BrowseAdapter.ViewHolder>() {
